var HeadlineData = [
  ...
  "{MATERIALS} surge on bets of {PLACE} rate hike, {MATERIALS} consolidate post crash",
  ...
  "{PLACE}'s {MATERIALS} down {NUMBER} percent, to hit {TIMESPAN} low on surprise stock build",
